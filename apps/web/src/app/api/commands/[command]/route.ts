...
const paths: Readonly<Record<string, string>> = {
  ...
  'work-rules': '/v1/workforce/work-rules',
  'work-rule-assignments': '/v1/workforce/work-rule-assignments',
  'employment-calendar-days': '/v1/workforce/employment-calendar-days',
  'working-time-enforcement': '/v1/workforce/working-time-enforcement',
